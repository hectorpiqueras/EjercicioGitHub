...
public class AppletAjedrez extends Applet {
    ...
    @Override
    public void init() {
        System.out.println("Siempre tienen que empezar la partida moviendo las fichas blancas.");
    ...
    public void paint(Graphics g) {
        t.pintar_imagen_fondo(g, imagen_fondo);
        t.pintar_tablero(g);
        t.pintar_fichas(g);
        t.pintar_fichas_comidas_por_blancas(g, comidas_por_blancas);
        t.pintar_fichas_comidas_por_negras(g, comidas_por_negras);
    }
